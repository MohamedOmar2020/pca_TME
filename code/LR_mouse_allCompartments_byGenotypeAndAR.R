...
# remove immune
mouse_all_meta <- mouse_all_meta[mouse_all_meta$compartment!='immune',]

mouse_all_meta$cluster_ARstatus <- droplevels(mouse_all_meta$cluster_ARstatus)
...
#############################################
cellchat_mouse_all_PN <- createCellChat(object = mouse_all_dataInput_PN, meta = mouse_all_meta_PN, group.by = "cluster_ARstatus")
cellchat_mouse_all_HiMYC <- createCellChat(object = mouse_all_dataInput_HiMYC, meta = mouse_all_meta_HiMYC, group.by = "cluster_ARstatus")
cellchat_mouse_all_Terg <- createCellChat(object = mouse_all_dataInput_Terg, meta = mouse_all_meta_Terg, group.by = "cluster_ARstatus")
cellchat_mouse_all_PRN <- createCellChat(object = mouse_all_dataInput_PRN, meta = mouse_all_meta_PRN, group.by = "cluster_ARstatus")
cellchat_mouse_all_FVBN <- createCellChat(object = mouse_all_dataInput_FVBN, meta = mouse_all_meta_FVBN, group.by = "cluster_ARstatus")
cellchat_mouse_all_B6 <- createCellChat(object = mouse_all_dataInput_B6, meta = mouse_all_meta_B6, group.by = "cluster_ARstatus")
cellchat_mouse_all_B6_129 <- createCellChat(object = mouse_all_dataInput_B6_129, meta = mouse_all_meta_B6_129, group.by = "cluster_ARstatus")
cellchat_mouse_all_PRN_wt <- createCellChat(object = mouse_all_dataInput_PRN_wt, meta = mouse_all_meta_PRN_wt, group.by = "cluster_ARstatus")
cellchat_mouse_all_PN_wt <- createCellChat(object = mouse_all_dataInput_PN_wt, meta = mouse_all_meta_PN_wt, group.by = "cluster_ARstatus")

#############################################
# Add cell information into meta slot of the object
#############################################
mouse_all_meta_PN$cluster_ARstatus <- droplevels(mouse_all_meta_PN$cluster_ARstatus)
cellchat_mouse_all_PN <- addMeta(cellchat_mouse_all_PN, meta = mouse_all_meta_PN)
cellchat_mouse_all_PN <- setIdent(cellchat_mouse_all_PN, ident.use = "cluster_ARstatus") # set "labels" as default cell identity
...
####
mouse_all_meta_HiMYC$cluster_ARstatus <- droplevels(mouse_all_meta_HiMYC$cluster_ARstatus)
cellchat_mouse_all_HiMYC <- addMeta(cellchat_mouse_all_HiMYC, meta = mouse_all_meta_HiMYC)
cellchat_mouse_all_HiMYC <- setIdent(cellchat_mouse_all_HiMYC, ident.use = "cluster_ARstatus") # set "labels" as default cell identity
...
####
mouse_all_meta_Terg$cluster_ARstatus <- droplevels(mouse_all_meta_Terg$cluster_ARstatus)
cellchat_mouse_all_Terg <- addMeta(cellchat_mouse_all_Terg, meta = mouse_all_meta_Terg)
cellchat_mouse_all_Terg <- setIdent(cellchat_mouse_all_Terg, ident.use = "cluster_ARstatus") # set "labels" as default cell identity
...
####
mouse_all_meta_PRN$cluster_ARstatus <- droplevels(mouse_all_meta_PRN$cluster_ARstatus)
cellchat_mouse_all_PRN <- addMeta(cellchat_mouse_all_PRN, meta = mouse_all_meta_PRN)
cellchat_mouse_all_PRN <- setIdent(cellchat_mouse_all_PRN, ident.use = "cluster_ARstatus") # set "labels" as default cell identity
...
####
mouse_all_meta_FVBN$cluster_ARstatus <- droplevels(mouse_all_meta_FVBN$cluster_ARstatus)
cellchat_mouse_all_FVBN <- addMeta(cellchat_mouse_all_FVBN, meta = mouse_all_meta_FVBN)
cellchat_mouse_all_FVBN <- setIdent(cellchat_mouse_all_FVBN, ident.use = "cluster_ARstatus") # set "labels" as default cell identity
...
####
mouse_all_meta_B6$cluster_ARstatus <- droplevels(mouse_all_meta_B6$cluster_ARstatus)
cellchat_mouse_all_B6 <- addMeta(cellchat_mouse_all_B6, meta = mouse_all_meta_B6)
cellchat_mouse_all_B6 <- setIdent(cellchat_mouse_all_B6, ident.use = "cluster_ARstatus") # set "labels" as default cell identity
...
####
mouse_all_meta_B6_129$cluster_ARstatus <- droplevels(mouse_all_meta_B6_129$cluster_ARstatus)
cellchat_mouse_all_B6_129 <- addMeta(cellchat_mouse_all_B6_129, meta = mouse_all_meta_B6_129)
cellchat_mouse_all_B6_129 <- setIdent(cellchat_mouse_all_B6_129, ident.use = "cluster_ARstatus") # set "labels" as default cell identity
...
####
mouse_all_meta_PRN_wt$cluster_ARstatus <- droplevels(mouse_all_meta_PRN_wt$cluster_ARstatus)
cellchat_mouse_all_PRN_wt <- addMeta(cellchat_mouse_all_PRN_wt, meta = mouse_all_meta_PRN_wt)
cellchat_mouse_all_PRN_wt <- setIdent(cellchat_mouse_all_PRN_wt, ident.use = "cluster_ARstatus") # set "labels" as default cell identity
...
####
mouse_all_meta_PN_wt$cluster_ARstatus <- droplevels(mouse_all_meta_PN_wt$cluster_ARstatus)
cellchat_mouse_all_PN_wt <- addMeta(cellchat_mouse_all_PN_wt, meta = mouse_all_meta_PN_wt)
cellchat_mouse_all_PN_wt <- setIdent(cellchat_mouse_all_PN_wt, ident.use = "cluster_ARstatus") # set "labels" as default cell identity
...
group.new = levels(mouse_all_meta$cluster_ARstatus)
...
######################################################
# from basal
png('./figures/Ar_binary/fromBasal_hiMYC2.png', width = 2500, height = 2500, res = 250)
netVisual_chord_gene(cellchat_mouse_all_HiMYC, 
                     slot.name = "net",
                     sources.use = c('basal_Ar+', 'basal_Ar-'), 
                     targets.use = c('c0_Ar-', 'c0_Ar+', 'c1_Ar-', 'c1_Ar+', 'c2_Ar+', 'c2_Ar-', 'c3_Ar+', 'c3_Ar-', 'c4_Ar+', 'c4_Ar-', 'c5_Ar+', 'c5_Ar-', 'c6_Ar+', 'c6_Ar-', 'c7_Ar+', 'c7_Ar-'), 
                     lab.cex = 0.55, 
                     legend.pos.y = 130, 
                     legend.pos.x = 5,
                     #reduce = -1,
                     ...
                     #directional = 2,
                     #color.use = colMap
                     title.name = 'Hi-MYC: signling networks from basal epithelial cells to stromal cells'	
)
dev.off()

# from luminal
png('./figures/Ar_binary/fromLuminal_hiMYC2.png', width = 2500, height = 2500, res = 250)
netVisual_chord_gene(cellchat_mouse_all_HiMYC, 
                     slot.name = "net",
                     sources.use = c('luminal_Ar+', 'luminal_Ar-'), 
                     targets.use = c('c0_Ar-', 'c0_Ar+', 'c1_Ar-', 'c1_Ar+', 'c2_Ar+', 'c2_Ar-', 'c3_Ar+', 'c3_Ar-', 'c4_Ar+', 'c4_Ar-', 'c5_Ar+', 'c5_Ar-', 'c6_Ar+', 'c6_Ar-', 'c7_Ar+', 'c7_Ar-'), 
                     lab.cex = 0.55, 
                     legend.pos.y = 130, 
                     legend.pos.x = 5,
                     ...
                     #directional = 2,
                     #color.use = colMap
                     title.name = 'Hi-MYC: signling networks from luminal epithelial cells to stromal cells'	
)
dev.off()
...
######################################################
# from basal
png('./figures/Ar_binary/fromBasal_Terg.png', width = 2500, height = 2500, res = 250)
netVisual_chord_gene(cellchat_mouse_all_Terg, 
                     ...
                     #directional = 2,
                     #color.use = colMap
                     title.name = 'T-ERG: signling networks from basal epithelial cells to stromal cells'	
)
dev.off()

# from luminal
png('./figures/Ar_binary/fromLuminal_Terg.png', width = 2500, height = 2500, res = 250)
netVisual_chord_gene(cellchat_mouse_all_Terg, 
                     slot.name = "net",
                     sources.use = c('luminal_Ar+', 'luminal_Ar-'), 
                     targets.use = c('c0_Ar-', 'c0_Ar+', 'c1_Ar-', 'c1_Ar+', 'c2_Ar+', 'c2_Ar-', 'c3_Ar+', 'c3_Ar-', 'c4_Ar+', 'c4_Ar-', 'c5_Ar+', 'c5_Ar-', 'c6_Ar+', 'c6_Ar-', 'c7_Ar+', 'c7_Ar-'), 
                     ...
                     #directional = 2,
                     #color.use = colMap
                     title.name = 'T-ERG: signling networks from luminal epithelial cells to stromal cells'	
)
dev.off()
...
######################################################
# from basal
png('./figures/Ar_binary/fromBasal_NP.png', width = 2500, height = 2500, res = 250)
netVisual_chord_gene(cellchat_mouse_all_PN, 
                     ...
                     #directional = 2,
                     #color.use = colMap
                     title.name = 'NP: signling networks from basal epithelial cells to stromal cells'	
)
dev.off()

# from luminal
png('./figures/Ar_binary/fromLuminal_NP.png', width = 2500, height = 2500, res = 250)
netVisual_chord_gene(cellchat_mouse_all_PN, 
                     slot.name = "net",
                     sources.use = c('luminal_Ar+', 'luminal_Ar-'), 
                     targets.use = c('c0_Ar-', 'c0_Ar+', 'c1_Ar-', 'c1_Ar+', 'c2_Ar+', 'c2_Ar-', 'c3_Ar+', 'c3_Ar-', 'c4_Ar+', 'c4_Ar-', 'c5_Ar+', 'c5_Ar-', 'c6_Ar+', 'c6_Ar-', 'c7_Ar+', 'c7_Ar-'), 
                     ...
                     #directional = 2,
                     #color.use = colMap
                     title.name = 'NP: signling networks from luminal epithelial cells to stromal cells'	
)
dev.off()
