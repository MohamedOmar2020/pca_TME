...
write.xlsx(net.up_mutants_vs_WT, file = 'tables/Source_data.xlsx', append = TRUE, row.names = F, sheetName = '3c-3e')
write.xlsx(net.up_Terg_vs_HiMYC, file = 'tables/Source_data.xlsx', append = TRUE, row.names = F, sheetName = '4c')
write.xlsx(net.up_PRN_vs_c3c4, file = 'tables/Source_data.xlsx', append = TRUE, row.names = F, sheetName = '4d')
